...
export const GlobalDatabase: FunctionComponent = () => {
  ...
  const features = [
    {
      name: "Global Pools",
      description: "Traders active across 50+ countries worldwide.",
    },
    {
      name: "24/7 Trading",
      description: "Automated systems running around the clock.",
    },
    {
      name: "Secure Transfers",
      description: "Protected transactions with instant confirmations.",
    },
  ]

  return (
    <div className="relative mx-auto mt-20 flex w-full max-w-6xl flex-col items-center justify-center overflow-hidden rounded-3xl bg-gray-950 pt-24 shadow-xl shadow-black/30">
      ...
      <h2 className="z-10 mt-6 inline-block bg-gradient-to-b from-white to-indigo-100 bg-clip-text px-2 text-center text-5xl font-bold tracking-tighter text-transparent md:text-8xl">
        Global <br /> Crypto Pool
      </h2>
      <canvas
